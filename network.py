...
from keras.layers import AveragePooling2D, Input, concatenate, Lambda, Dense, multiply
...
def model_resnet(num_classes,input_shape=[128,None,5],num_filters=24,wd=1e-3):
    My_wd = wd
    num_res_blocks=2
